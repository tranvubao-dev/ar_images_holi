...
class ARQuidoMethodChannel extends ARQuidoPlatform {
  ...
  Widget buildView(
    ...
    required List<String> referenceImageUrl,
    required String server,
  }) {
    final creationParams =
        _buildCreationParams(referenceImageNames, referenceImageUrl, server);
  ...
  Map<String, dynamic> _buildCreationParams(
    List<String> referenceImageNames,
    List<String> referenceImageUrl,
    String server,
  ) =>
      <String, dynamic>{
